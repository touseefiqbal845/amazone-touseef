...
import { addToCart, removeFromCart, increaseQuantity, decreaseQuantity } from "../redux/actions/productaction";
import Footer from "./footer"; 

// import emptyCart from "./src/assets/emptyCart.png"; // Replace 'png' with the actual file extension of your image
...
const Cart = () => {
  ...
  const [cartItemsState, setCartItems] = useState([]); // Define the state and the setter function using useState
        ...
        <div className="container mx-auto h-auto grid grid-cols-5 gap-8">
          <div className="w-full bg-white px-4 col-span-5 xl:col-span-4">
            ...
            <div className="font-titleFont hidden xl:flex items-center justify-between border-b-[1px] border-b-gray-400 py-3">
              ...
              <p className="font-bold border rounded px-6 py-1 flex items-center justify-between">
                  Total: <h2 className="text-lg font-bold">${totalAmount}</h2>
                </p>
                </div>
          ...
          <div className="col-span-5 md:col-span-3 lg:col-span-2 xl:col-span-1 bg-white h-52 flex items-center p-4">
            <div>
              <p className="flex gap-2 items-start text-sm">
                {/* <span>
                  < fclassName="bg-white text-green-500 rounded-full" />
                </span> */}
              ...
              <div>
                <p className="font-semibold px-6 py-1 flex items-center justify-between">
                  GTotal: <span className="text-lg font-bold">${totalAmount}</span>
                </p>
              </div>
